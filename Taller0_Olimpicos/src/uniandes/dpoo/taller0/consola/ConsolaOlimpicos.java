...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("14 Ingrese el nombre del atleta");
	}
	...
	private void ejecutarBuscarNombre()
		...
		String nombre = input("Ingresa el nombre del atleta");
		List<Map<String, Object>> nombres = calculadora.buscarAtleta(nombre);
			...
			{
				for (Map<String, Object> datos : nombres)
				{
				String nom = (String) datos.get("nombre");
				String pais = (String) datos.get("pais");
				System.out.println(" El atleta" + nom + " representa al pais" + pais + ".");
				}
			}
	}
	/**
